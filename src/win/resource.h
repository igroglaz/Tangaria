...
#define IDM_WINDOW_BIZ                  230
#define IDM_WINDOW_I_WID                240
#define IDM_WINDOW_D_WID                250
#define IDM_WINDOW_I_HGT                260
#define IDM_WINDOW_D_HGT                270
