...
EFFECT(BREATH, true, "dam", 2, EFINFO_BREATH, "allows you to breathe %s for %s points of damage")
...
EFFECT(PROJECT_LOS, false, "dam", 1, EFINFO_SEEN, "%s all monsters within line of sight")
...
EFFECT(SCRAMBLE_STATS, false, NULL, 0, EFINFO_NONE, NULL)
...
EFFECT(UNSCRAMBLE_STATS, false, NULL, 0, EFINFO_NONE, NULL)
...
EFFECT(BOLT_RADIUS, true, "dam", 2, EFINFO_BOLT_RADIUS, "shoots a bolt of %s with distance %d that inflicts %s points of damage")
EFFECT(SAND_WALL, false, NULL, 0, EFINFO_NONE, "creates a sandwall")