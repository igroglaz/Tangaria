...
extern bool do_cmd_use_staff(struct player *p, int item, int dir);
extern bool do_cmd_aim_wand(struct player *p, int item, int dir);
extern bool do_cmd_zap_rod(struct player *p, int item, int dir);
extern bool do_cmd_activate(struct player *p, int item, int dir);
...
extern bool do_cmd_use_any(struct player *p, int item, int dir);
