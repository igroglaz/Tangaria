...
OP(weather_display, "Show weather", INTERFACE, true, false)
OP(animations, "Animations", INTERFACE, true, false)
OP(slash_fx, "Show monsters attack", INTERFACE, true, false)
