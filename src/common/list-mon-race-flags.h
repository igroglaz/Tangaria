...
RF(NO_CUT, RFT_PROT, "cut")

/* PWMAngband */
RF(PWMANG_BASE, RFT_NONE, "")
RF(PWMANG_EXTRA, RFT_NONE, "")
RF(PWMANG_FIXED, RFT_NONE, "")
RF(PWMANG_FINAL, RFT_NONE, "")
RF(HAS_LEGS, RFT_NONE, "") /* RFT_OBV */
RF(ANTI_MAGIC, RFT_NOTE, "")
RF(LEVITATE, RFT_NOTE, "")
RF(HUMANOID, RFT_NONE, "") /* RFT_RACE_A */
RF(HYBRID, RFT_NONE, "")
RF(WANDERER, RFT_NONE, "")
RF(ABOMINATION, RFT_NONE, "")
RF(AQUATIC, RFT_NONE, "")
RF(FRIENDLY, RFT_NONE, "") /* RFT_BEHAV */
RF(NO_DEATH, RFT_NONE, "")
RF(NO_PIT, RFT_NONE, "")
RF(DROP_SKELETON, RFT_NONE, "") /* RFT_DROP */
RF(DROP_CORPSE, RFT_NONE, "")
RF(WILD_ALL, RFT_NONE, "") /* RFT_WILD */
RF(WILD_SHORE, RFT_NONE, "")
RF(WILD_OCEAN, RFT_NONE, "")
RF(WILD_WASTE, RFT_NONE, "")
RF(WILD_VOLCANO, RFT_NONE, "")
RF(WILD_GRASS, RFT_NONE, "")
RF(WILD_WOOD, RFT_NONE, "")
RF(WILD_DESERT, RFT_NONE, "")
RF(WILD_GLACIER, RFT_NONE, "")
RF(WILD_SWAMP, RFT_NONE, "")
RF(WILD_MOUNTAIN, RFT_NONE, "")
...
RF(RES_ACID, RFT_RES, "resist acid")
RF(SRES_ACID, RFT_RES, "resist acid somewhat")
RF(RES_ELEC, RFT_RES, "resist lightning")
RF(SRES_ELEC, RFT_RES, "resist lightning somewhat")
RF(NO_PASS_TREE, RFT_ALTER, "don't pass through trees")
RF(SWIM_GOOD, RFT_NOTE, "good at swimming")
RF(SWIM_BAD, RFT_NOTE, "can pass water with some effort")
RF(SWIM_NORM, RFT_NOTE, "can swim")
RF(RAND_100, RFT_BEHAV, "")
RF(GOOD, RFT_RACE_A, "good")
RF(NEUTRAL, RFT_RACE_A, "neutral")
RF(RES_MANA, RFT_RES, "resist mana")
RF(RES_WATER, RFT_RES, "resist water")
RF(RES_PLASMA, RFT_RES, "resist plasma")
