...
RSF(SHOT, RST_BOLT|RST_MISSILE|RST_INNATE|RST_ARCHERY, 0)
RSF(ARROW, RST_BOLT|RST_MISSILE|RST_INNATE|RST_ARCHERY, 0)
RSF(BOLT, RST_BOLT|RST_MISSILE|RST_INNATE|RST_ARCHERY, 0)
...
RSF(BO_DARK, RST_BOLT, 0)
RSF(BO_LIGHT, RST_BOLT, 0)
