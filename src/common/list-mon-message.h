...
MON_MSG(RESIST_A_LOT, MSG_RESIST_A_LOT, false, ">>> resist[s] a lot.")
MON_MSG(HIT_HARD, MSG_GENERIC, false, "[is|are] hit hard.")
MON_MSG(RESIST, MSG_RESIST, false, "~~~ resist[s].")
MON_MSG(IMMUNE, MSG_IMMUNE, false, "[is|are] ||| immune.")
MON_MSG(RESIST_SOMEWHAT, MSG_RESIST_SOMEWHAT, false, "resist[s] somewhat.")
MON_MSG(UNAFFECTED, MSG_UNAFFECTED, false, "[is|are] !!! unaffected!")
...
MON_MSG(SHAPE_FAIL, MSG_GENERIC, false, "shimmer[s] for a moment.")
